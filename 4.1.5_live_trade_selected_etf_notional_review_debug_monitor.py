...
def format_status_line(now: datetime, symbol: str, latest_close: float, prob: float, p_enter: float, raw_signal: bool, near_miss: bool, state: PositionState, metrics: SessionMetrics, event_note: str = "") -> str:
...
def main() -> None:
    ...
    try:
        while True:
            ...
            print(format_status_line(now, symbol, latest_close, prob, p_enter, raw_signal, near_miss, state, metrics, event_note))
