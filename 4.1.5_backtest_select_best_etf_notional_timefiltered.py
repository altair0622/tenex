#!/usr/bin/env python3
"""
4.1.5_backtest_select_best_etf_notional.py
...
def main() -> None:
    ...
    ap.add_argument("--out_dir", default="selector_out_415")
    ...
    selection_json = {
        "version": "4.1.5",
        "selection_mode": "single_best_etf_daily_return_on_notional_walkforward",
